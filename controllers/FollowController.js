/**
 * The FollowController file is a very simple one, which does not need to be changed manually,
...
const apiFollowPOST = async (request, response) => {
    await Controller.handleRequest(request, response, service.apiFollowPOST)
}
